...
#define test_bit(nr, addr)                   \
	(((1UL << ((nr) % (sizeof(long) * 8))) & \
	  ((addr)[(nr) / (sizeof(long) * 8)])) != 0)
#define NBITS(x) ((((x)-1) / (sizeof(long) * 8)) + 1)
		...
		public:
			...
			static const TCHAR* Name() { return "Evdev"; }
		...
		static void CalcAxisCorr(axis_correct& abs_correct,
