...
namespace usb_hid
{
	...
	public:
		...
		static const TCHAR* Name() { return TEXT("HID Keyboard"); }
		static const char* TypeName() { return "hidkbd"; }
	...
	public:
		...
		static USBDevice* CreateDevice(int port);
		static const TCHAR* Name() { return TEXT("HID Mouse"); }
		static const char* TypeName() { return "hidmouse"; }
		static std::list<std::string> ListAPIs();
		static const TCHAR* LongAPIName(const std::string& name);
		static int Configure(int port, const std::string& api, void* data);
		static int Freeze(int mode, USBDevice* dev, void* data);
	...
	public:
		...
		static USBDevice* CreateDevice(int port);
		static const TCHAR* Name() { return TEXT("BeatMania Da Da Da!! Keyboard"); }
		static const char* TypeName() { return "beatmania"; }
		static std::list<std::string> ListAPIs();
		static const TCHAR* LongAPIName(const std::string& name);
		static int Configure(int port, const std::string& api, void* data);
		static int Freeze(int mode, USBDevice* dev, void* data);
