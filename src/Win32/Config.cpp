...
{
	int sel = SendDlgItemMessage(hW, port ? IDC_COMBO_WHEEL_TYPE1 : IDC_COMBO_WHEEL_TYPE2, CB_GETCURSEL, 0, 0);
	int devtype = SendDlgItemMessage(hW, port ? IDC_COMBO1 : IDC_COMBO2, CB_GETCURSEL, 0, 0);
	if (devtype == 0)
		return;
	devtype--;
...
{
	SendDlgItemMessage(hW, port ? IDC_COMBO_WHEEL_TYPE1 : IDC_COMBO_WHEEL_TYPE2, CB_RESETCONTENT, 0, 0);
	int devtype = SendDlgItemMessage(hW, port ? IDC_COMBO1 : IDC_COMBO2, CB_GETCURSEL, 0, 0);
	if (devtype == 0)
		return;
	devtype--;
	...
	{
		SendDlgItemMessageA(hW, port ? IDC_COMBO_WHEEL_TYPE1 : IDC_COMBO_WHEEL_TYPE2, CB_ADDSTRING, 0, (LPARAM)subtype.c_str());
	}
	SendDlgItemMessage(hW, port ? IDC_COMBO_WHEEL_TYPE1 : IDC_COMBO_WHEEL_TYPE2, CB_SETCURSEL, sel, 0);
}
				...
				case CBN_SELCHANGE:
					switch (LOWORD(wParam))
					{
						...
						case IDC_COMBO2:
							...
							break;
						case IDC_COMBO_WHEEL_TYPE1:
						case IDC_COMBO_WHEEL_TYPE2:
							port = (LOWORD(wParam) == IDC_COMBO_WHEEL_TYPE1) ? 1 : 0;
