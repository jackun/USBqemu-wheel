...
namespace usb_mic
{
	namespace audiodev_noop
	{
		...
		public:
			...
			void Start() {}
			void Stop() {}
			virtual bool GetFrames(uint32_t* size) { return true; }
			...
			virtual uint32_t GetChannels() { return 1; }

			virtual bool Compare(AudioDevice* compare) { return false; }

			static const TCHAR* Name() { return TEXT("NOOP"); }

			static bool AudioInit() { return true; }
