...
uint64_t ohci_mem_read(void *opaque, hwaddr addr, unsigned size);
void ohci_mem_write(void *opaque, hwaddr addr, uint64_t val, unsigned size);
...
//FIXME haven't been brought up to date yet
...
#define dma_memory_read(a,b,c,d) address_space_rw(a,b,(uint8_t*)c,d, false)
#define dma_memory_write(a,b,c,d) address_space_rw(a,b,(uint8_t*)c,d, true)
